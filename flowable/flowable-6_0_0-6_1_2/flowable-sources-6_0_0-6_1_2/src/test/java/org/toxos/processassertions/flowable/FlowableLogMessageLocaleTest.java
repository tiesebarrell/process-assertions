 ...
 *
 */
public class FlowableLogMessageLocaleTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(FlowableLogMessageLocaleTest.class);

    private static final String LOG_MESSAGES = "org.toxos.processassertions.flowable.messages.LogMessages";
