 ...
 * 
 */
public class LogMessageLocaleTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(LogMessageLocaleTest.class);

    private static final String LOG_MESSAGES = "org.toxos.processassertions.messages.LogMessages";
